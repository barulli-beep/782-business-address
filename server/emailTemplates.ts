...
export const emailTemplates = {
  ...
  customerConfirmation: (customerName: string, planName: string, questionnairLink: string) => ({
  ...
  sellerConfirmation: (customerName: string, customerEmail: string, customerPhone: string, planName: string) => ({
